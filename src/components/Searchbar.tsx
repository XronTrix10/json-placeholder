...
const Searchbar = () => {
  return (
    <form className="mb-3 mx-auto mt-8">
      <div className="relative mb-4 flex w-full flex-wrap items-stretch">
        ...
        <button
          className="relative bg-red-600 z-[2] flex items-center rounded-r-full bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg"
          type="button"
          id="button-addon1"
          data-te-ripple-init
